...
function randomTwo() { // this is to convert data while get it from local storage as the orginal random function was prototype (Re-instantiate)
...
function render() {// this is to convert data while get it from local storage as the orginal rendering function was prototype (Re-instantiate)
    for (let j = 0; j < arrOfall; j++) {
        let tableInfo = document.createElement('tr');
        table.appendChild(tableInfo);
